...
#sudo pacman -S hyprland hyprpaper wget cliphist openssh tlp brightnessctl pavucontrol fuse kitty nano firefox  # Essentials 
...
mv bash ~/.bashrc
mv kitty obsidian rofi hypr .config/
